...
const HOW_TO = [
  ...
  },
  {
    ...
    steps: [
      "Best for you — Measuring wheel: roll it down the center of the curve, following the shape, and read the total. Fast and accurate.",
      "Tape method — Segment: mark a point every 2–3 ft along the curve with chalk or flags.",
      "Measure each short straight piece with your 25 ft tape and add them all up. (Use this where the wheel won't roll — gravel, steps, tight spots.)",
      "For a curve longer than 25 ft, just stop at 25, mark it, and keep going — add the pieces.",
      "Tip: stay on the center line — measuring along an edge gives a longer or shorter number.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Quick way: use the measuring wheel for the length, then your 25 ft tape for each width.",
    ],
  },
  {
    icon: Spline,
